...
class ApiVersionsResponseV2Test < Minitest::Test
  def test_encode
    ...
    # \x00\x00\x00\x14 - Message Length (20 bytes)
    ...
    # - \x00\x00 (Min Version)
    # - \x00\x0A (Max Version)
    # - \x00\x00\x00\x00 (Throttle Time)
    assert_equal format_as_hex("\x00\x00\x00\x14\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00\x00\x00\x00\x00\x0A\x00\x00\x00\x00"), format_as_hex(response.encode)
  end
